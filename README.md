...
`scripts/download_data.R` automatically downloads and reconstructs the required raw datasets into the correct `data/raw/` directories so the full analysis pipeline can be reproduced without storing large files in the repository.
